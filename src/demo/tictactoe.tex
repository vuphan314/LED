...
\begin{ledDef}
\funDefNoWhere{xImage \parentheses{c}}{text \parentheses{\texttt{"x"}, point \parentheses{centerX \parentheses{c}, centerY \parentheses{c}}, fontSize, BLUE}}
\end{ledDef}

\begin{ledDef}
\funDefNoWhere{oImage \parentheses{c}}{text \parentheses{\texttt{"o"}, point \parentheses{centerX \parentheses{c}, centerY \parentheses{c}}, fontSize, GREEN}}
\end{ledDef}
...
\begin{cases}
\termIfBoolTerm{\setNonempty{text \parentheses{\texttt{"x's turn"}, point \parentheses{100, 750}, fontSize, BLACK}}}{\eq{playerToMove}{`x}}
\termOw{\setNonempty{text \parentheses{\texttt{"o's turn"}, point \parentheses{100, 750}, fontSize, BLACK}}}
\end{cases}
}
\end{ledDef}
...
\begin{cases}
\termIfBoolTerm{\setNonempty{text \parentheses{\texttt{"x won"}, point \parentheses{200, 750}, fontSize, BLUE}}}{threeInRow \parentheses{`x}}
\termIfBoolTerm{\setNonempty{text \parentheses{\texttt{"o won"}, point \parentheses{200, 750}, fontSize, GREEN}}}{threeInRow \parentheses{`o}}
\termOw{\setNonempty{text \parentheses{\texttt{"cat got it"}, point \parentheses{200, 750}, fontSize, RED}}}
\end{cases}
}
\end{ledDef}
